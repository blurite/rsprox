...
public class OldSchoolNpcType(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (drawpriority != other.drawpriority) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + drawpriority.hashCode()
