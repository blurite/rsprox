package net.rsprox.protocol.rs3v949.game.outgoing.model.inv

import net.rsprox.protocol.game.outgoing.model.IncomingServerGameMessage
import net.rsprox.protocol.rs3v949.game.outgoing.model.inv.util.InvVar

public class UpdateInvFull(
    ...
    override fun toString(): String {
        return "UpdateInvFull(inventoryId=$inventoryId, flags=$flags, objs=$objs)"
    }
    ...
    public class Obj(
        ...
        override fun toString(): String {
            return "Obj(id=$id, count=$count, vars=$vars)"
        }
    }
}
