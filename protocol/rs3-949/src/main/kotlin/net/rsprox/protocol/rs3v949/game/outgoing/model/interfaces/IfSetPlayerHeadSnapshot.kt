...
public class IfSetPlayerHeadSnapshot(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as IfSetPlayerHeadSnapshot
    ...
    override fun toString(): String {
        return "IfSetPlayerHeadSnapshot(componentHash=$componentHash, snapshotSlot=$snapshotSlot)"
    }
}
