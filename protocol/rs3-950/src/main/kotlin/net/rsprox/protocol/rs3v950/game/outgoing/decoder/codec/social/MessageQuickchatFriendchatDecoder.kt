...
internal class MessageQuickchatFriendchatDecoder : ProxyMessageDecoder<MessageQuickchatFriendchat> {
    override val prot: ClientProt = GameServerProt.MESSAGE_QUICKCHAT_FRIENDCHAT

    override fun decode(
        buffer: JagByteBuf,
        session: Session,
    ): MessageQuickchatFriendchat {
        ...
        return MessageQuickchatFriendchat(
            alternateSenderFlag,
            sender,
            alternateSender,
            channelName,
