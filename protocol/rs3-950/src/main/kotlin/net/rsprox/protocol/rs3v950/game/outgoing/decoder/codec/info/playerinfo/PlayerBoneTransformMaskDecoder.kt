...
internal object PlayerBoneTransformMaskDecoder {
    fun decode(buffer: JagByteBuf): PlayerExtendedInfo.BoneTransforms {
        val count = buffer.g1Alt3().toByte().toInt()
        val transforms = List(count.coerceAtLeast(0)) {
            ...
            // Bit 6 is not an axis-presence bit. Scale starts at bit 7.
            ...
            PlayerExtendedInfo.BoneTransform(flags, slot, id, translation, rotation, scale)
        }
        return PlayerExtendedInfo.BoneTransforms(count, transforms)
    }
}
