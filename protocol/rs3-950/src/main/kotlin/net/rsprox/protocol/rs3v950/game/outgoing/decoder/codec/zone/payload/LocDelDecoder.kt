...
internal class LocDelDecoder : ProxyMessageDecoder<LocDel> {
    ...
    override fun decode(
        ...
        // The shared native shape reader also accepts an extension in enclosed updates.
        // Standalone framing stays two bytes; an incomplete extension must fail normally.
