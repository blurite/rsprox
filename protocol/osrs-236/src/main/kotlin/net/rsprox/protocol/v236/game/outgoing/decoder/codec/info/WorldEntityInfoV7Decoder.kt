package net.rsprox.protocol.v236.game.outgoing.decoder.codec.info
...
import net.rsprox.protocol.v236.game.outgoing.model.info.npcinfo.NpcInfoClient
import net.rsprox.protocol.v236.game.outgoing.model.info.playerinfo.PlayerInfoClient
import net.rsprox.protocol.v236.game.outgoing.model.info.worldentityinfo.WorldEntityInfoClient

internal class WorldEntityInfoV7Decoder(
    private val huffmanCodec: HuffmanCodec,
    private val cache: CacheProvider,
) : ProxyMessageDecoder<WorldEntityInfo> {
    override val prot: ClientProt = GameServerProt.WORLDENTITY_INFO_V7
