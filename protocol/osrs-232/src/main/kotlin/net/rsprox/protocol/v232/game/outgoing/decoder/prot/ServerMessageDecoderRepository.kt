...
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamLookAtDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamLookAtEasedCoordDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamModeDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamMoveToArcDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamMoveToCyclesDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamMoveToDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamResetDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamRotateBy
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamRotateToDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamShakeDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamSmoothResetDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.CamTargetV3Decoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.camera.OculusSyncDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.ClanChannelDeltaDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.ClanChannelFullDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.ClanSettingsDeltaDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.ClanSettingsFullDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.MessageClanChannelDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.MessageClanChannelSystemDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.VarClanDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.VarClanDisableDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.clan.VarClanEnableDecoder
...
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.info.*
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.*
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfResyncV1Decoder
...
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetEventsV1Decoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetHideDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetModelDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetNpcHeadActiveDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetNpcHeadDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetObjectDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetPlayerHeadDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetPlayerModelBaseColourDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetPlayerModelBodyTypeDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetPlayerModelObjDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetPlayerModelSelfDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetPositionDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetRotateSpeedDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetScrollPosDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.interfaces.IfSetTextDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.inv.UpdateInvFullDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.inv.UpdateInvPartialDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.inv.UpdateInvStopTransmitDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.logout.LogoutDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.logout.LogoutTransferDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.logout.LogoutWithReasonDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.map.RebuildRegionDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.map.RebuildWorldEntityV3Decoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.map.ReconnectDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.map.StaticRebuildDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.*
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.HideLocOpsDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.HideNpcOpsDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.HideObjOpsDecoder
...
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.SendPingDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.ServerTickEndDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.SetHeatmapEnabledDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.SetInteractionModeDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.SiteSettingsDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.UpdateRebootTimerDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.UpdateUid192Decoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.client.UrlOpenDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.player.ChatFilterSettingsDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.player.ChatFilterSettingsPrivateChatDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.player.MessageGameDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.player.RunClientScriptDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.player.SetMapFlagDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.player.SetPlayerOpDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.misc.player.TriggerOnDialogAbortDecoder
...
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.social.UpdateFriendListDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.social.UpdateIgnoreListDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.sound.MidiJingleDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.sound.MidiSongStopDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.sound.MidiSongV2Decoder
...
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.specific.ProjAnimSpecificV3Decoder
...
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.varp.VarpSmallDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.varp.VarpSyncDecoder
import net.rsprox.protocol.v232.game.outgoing.decoder.codec.worldentity.SetActiveWorldV2Decoder
