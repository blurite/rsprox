...
import net.rsprox.protocol.v233.game.incoming.decoder.codec.misc.user.ExitFreecamDecoder
import net.rsprox.protocol.v233.game.incoming.decoder.codec.misc.user.HiscoreRequestDecoder
import net.rsprox.protocol.v233.game.incoming.decoder.codec.misc.user.IfCrmViewOpDecoder
...
import net.rsprox.protocol.v233.game.incoming.decoder.codec.worldentities.OpWorldEntity1Decoder
import net.rsprox.protocol.v233.game.incoming.decoder.codec.worldentities.OpWorldEntity2Decoder
import net.rsprox.protocol.v233.game.incoming.decoder.codec.worldentities.OpWorldEntity3Decoder
import net.rsprox.protocol.v233.game.incoming.decoder.codec.worldentities.OpWorldEntity4Decoder
import net.rsprox.protocol.v233.game.incoming.decoder.codec.worldentities.OpWorldEntity5Decoder
import net.rsprox.protocol.v233.game.incoming.decoder.codec.worldentities.OpWorldEntity6Decoder
import net.rsprox.protocol.v233.game.incoming.decoder.codec.worldentities.OpWorldEntityTDecoder
