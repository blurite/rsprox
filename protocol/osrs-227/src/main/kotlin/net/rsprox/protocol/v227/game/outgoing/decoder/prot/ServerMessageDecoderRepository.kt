...
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.camera.CamLookAtDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.camera.CamLookAtEasedCoordDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.camera.CamModeDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.camera.CamMoveToArcDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.camera.CamMoveToCyclesDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.camera.CamMoveToDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.camera.CamResetDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.camera.CamRotateBy
...
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.clan.ClanChannelFullDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.clan.ClanSettingsDeltaDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.clan.ClanSettingsFullDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.clan.MessageClanChannelDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.clan.MessageClanChannelSystemDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.clan.VarClanDecoder
...
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.info.SetNpcUpdateOriginDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.info.WorldEntityInfoV3Decoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfClearInvDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfCloseSubDecoder
...
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetNpcHeadDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetObjectDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetPlayerHeadDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetPlayerModelBaseColourDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetPlayerModelBodyTypeDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetPlayerModelObjDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetPlayerModelSelfDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetPositionDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetRotateSpeedDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetScrollPosDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.interfaces.IfSetTextDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.inv.UpdateInvFullDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.inv.UpdateInvPartialDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.inv.UpdateInvStopTransmitDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.logout.LogoutDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.logout.LogoutTransferDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.logout.LogoutWithReasonDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.map.RebuildRegionDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.map.RebuildWorldEntityV2Decoder
...
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.HintArrowDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.HiscoreReplyDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.MinimapToggleDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.ReflectionCheckerDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.ResetAnimsDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.ResetInteractionModeDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.SendPingDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.ServerTickEndDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.SetHeatmapEnabledDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.SetInteractionModeDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.SiteSettingsDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.UpdateRebootTimerDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.UpdateUid192Decoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.client.UrlOpenDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.player.ChatFilterSettingsDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.player.ChatFilterSettingsPrivateChatDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.player.MessageGameDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.player.RunClientScriptDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.player.SetMapFlagDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.misc.player.SetPlayerOpDecoder
...
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.social.FriendListLoadedDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.social.MessagePrivateDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.social.MessagePrivateEchoDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.social.UpdateFriendListDecoder
...
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.sound.SynthSoundDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.specific.LocAnimSpecificDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.specific.MapAnimSpecificDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.specific.NpcAnimSpecificDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.specific.NpcHeadIconSpecificDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.specific.NpcSpotAnimSpecificDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.specific.PlayerAnimSpecificDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.specific.PlayerSpotAnimSpecificDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.specific.ProjAnimSpecificV3Decoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.unknown.UnknownStringDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.varp.VarpLargeDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.varp.VarpResetDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.varp.VarpSmallDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.varp.VarpSyncDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.worldentity.ClearEntitiesDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.worldentity.SetActiveWorldV1Decoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.header.UpdateZoneFullFollowsDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.header.UpdateZonePartialEnclosedDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.header.UpdateZonePartialFollowsDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.payload.LocAddChangeDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.payload.LocAnimDecoder
...
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.payload.ObjDelDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.payload.ObjEnabledOpsDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.payload.ObjUncustomiseDecoder
import net.rsprox.protocol.v227.game.outgoing.decoder.codec.zone.payload.SoundAreaDecoder
