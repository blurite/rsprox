package net.rsprox.protocol.v228.game.outgoing.model.info.playerinfo
...
internal class PlayerInfoClient(
    ...
    private fun decodeMoveSpeed(
        ...
        blocks += MoveSpeedExtendedInfo(buffer.g1Alt3())
    }
    ...
    private fun decodeTemporaryMoveSpeed(
        ...
        blocks += TemporaryMoveSpeedExtendedInfo(buffer.g1Alt2())
    }
    ...
    private fun decodeFaceAngle(
        ...
        blocks += FaceAngleExtendedInfo(buffer.g2())
    }
