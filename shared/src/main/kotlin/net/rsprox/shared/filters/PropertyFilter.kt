...
public enum class PropertyFilter(
    ...
    PLAYER_INFO_OMIT_NO_EXTENDED_INFO(SERVER_TO_CLIENT, INFO, "Hide Players W/O Ext. Info", true),
    PLAYER_INFO_OMIT_EMPTY(SERVER_TO_CLIENT, INFO, "Hide Empty Player Info", true),
    ...
    NPC_INFO_OMIT_NO_EXTENDED_INFO(SERVER_TO_CLIENT, INFO, "Hide Npcs W/O Ext. Info", true),
    NPC_INFO_OMIT_EMPTY(SERVER_TO_CLIENT, INFO, "Hide Empty Npc Info", true),
