...
public class TranscriberPlugin(
    ...
    override fun onServerPacket(
        ...
        when (prot) {
            ...
            GameServerProt.PROJANIM_SPECIFIC_OLD_OLD -> throw IllegalArgumentException("Unimplemented packet")
            ...
            GameServerProt.WORLDENTITY_INFO_OLD -> throw IllegalArgumentException("Unimplemented packet")
    ...
    override fun onClientProt(
        ...
        when (prot) {
            ...
            GameClientProt.UPDATE_PLAYER_MODEL_OLD -> pass(message, Transcriber::updatePlayerModelOld)
            GameClientProt.UPDATE_PLAYER_MODEL -> throw IllegalArgumentException("Unexpected packet")
