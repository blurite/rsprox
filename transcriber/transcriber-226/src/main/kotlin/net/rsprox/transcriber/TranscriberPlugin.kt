...
public class TranscriberPlugin(
    ...
    override fun onServerPacket(
        ...
        when (prot) {
            ...
            GameServerProt.MIDI_SONG_V2 -> pass(message, Transcriber::midiSong)
            ...
            GameServerProt.MIDI_SONG_V1 -> pass(message, Transcriber::midiSongOld)
            ...
            GameServerProt.PROJANIM_SPECIFIC_V3 -> pass(message, Transcriber::projAnimSpecific)
            ...
            GameServerProt.NPC_INFO_SMALL_V5 -> pass(message, Transcriber::npcInfo)
            GameServerProt.NPC_INFO_LARGE_V5 -> pass(message, Transcriber::npcInfo)
            ...
            GameServerProt.WORLDENTITY_INFO_V3 -> pass(message, Transcriber::worldEntityInfo)
            ...
            GameServerProt.CAM_TARGET_V2 -> pass(message, Transcriber::camTarget)
            GameServerProt.CAM_TARGET_V1 -> pass(message, Transcriber::camTargetOld)
            ...
            GameServerProt.UPDATE_STAT_V2 -> pass(message, Transcriber::updateStat)
            GameServerProt.UPDATE_STAT_V1 -> pass(message, Transcriber::updateStatOld)
    ...
    override fun onClientProt(
        ...
        when (prot) {
            ...
            GameClientProt.UPDATE_PLAYER_MODEL_V1 -> pass(message, Transcriber::updatePlayerModelOld)
