...
public class TranscriberPlugin(
    ...
    override fun onServerPacket(
        ...
        when (serverProt) {
            ...
            GameServerProt.CAM_LOOKAT_EASED_COORD_V1 -> pass(message, Transcriber::camLookAtEasedCoordV1)
            GameServerProt.CAM_LOOKAT_EASED_COORD_V2 -> pass(message, Transcriber::camLookAtEasedCoordV2)
