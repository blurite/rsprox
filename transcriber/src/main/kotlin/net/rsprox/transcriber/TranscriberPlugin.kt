...
public class TranscriberPlugin(
    ...
    override fun onServerPacket(
        ...
        when (serverProt) {
            ...
            GameServerProt.AMBIENTSOUND_START -> pass(message, Transcriber::ambientSoundStart)
            GameServerProt.AMBIENTSOUND_STOP -> pass(message, Transcriber::ambientSoundStop)
            ...
            GameServerProt.CAM_LOOKAT_CYCLES -> pass(message, Transcriber::camLookAtCycles)
            ...
            GameServerProt.CAM_ROTATETO_COORDINATE_V3 -> pass(message, Transcriber::camRotateToCoordinateV3)
            ...
            GameServerProt.CAM_TARGET_V4 -> pass(message, Transcriber::camTargetV4)
            ...
            GameServerProt.CAM_SKYBOX -> pass(message, Transcriber::camSkybox)
            GameServerProt.CAM_UNLOCK -> pass(message, Transcriber::camUnlock)
            ...
            GameServerProt.GROUP_FULL -> pass(message, Transcriber::groupFull)
            GameServerProt.GROUP_VAR -> pass(message, Transcriber::groupVar)
            GameServerProt.GROUP_VAR_INT -> pass(message, Transcriber::groupVarInt)
            GameServerProt.GROUP_VAR_LONG -> pass(message, Transcriber::groupVarLong)
            ...
            GameServerProt.SET_MAP_FLAG_V1 -> pass(message, Transcriber::setMapFlagV1)
            GameServerProt.SET_MAP_FLAG_V2 -> pass(message, Transcriber::setMapFlagV2)
            ...
            GameServerProt.UPDATE_REBOOT_TIMER_V1 -> pass(message, Transcriber::updateRebootTimerV1)
            GameServerProt.UPDATE_REBOOT_TIMER_V2 -> pass(message, Transcriber::updateRebootTimerV2)
    ...
    override fun onClientProt(
        ...
        when (clientProt) {
            ...
            GameClientProt.OPLOC1_V1 -> pass(message, Transcriber::opLocV1)
            GameClientProt.OPLOC2_V1 -> pass(message, Transcriber::opLocV1)
            ...
            GameClientProt.OPOBJ1_V1 -> pass(message, Transcriber::opObjV1)
            GameClientProt.OPOBJ2_V1 -> pass(message, Transcriber::opObjV1)
