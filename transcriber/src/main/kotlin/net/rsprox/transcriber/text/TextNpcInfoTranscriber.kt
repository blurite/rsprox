...
public class TextNpcInfoTranscriber(
                    ...
                    when (update) {
                        ...
                        is NpcUpdateType.LowResolutionToHighResolution -> {
                            ...
                            group("ADD") {
                                ...
                                any("spawnangle", jagAngleToDirectionInWords(update.angle))
    ...
    private fun jagAngleToDirectionInWords(angle: Int): String {
        return when (angle) {
            0 -> "south"
            256 -> "south-west"
            512 -> "west"
        ...
        for (info in extendedInfo) {
            when (info) {
                ...
                is FacePathingEntityExtendedInfo -> {
                    if (filters[PropertyFilter.NPC_FACING]) {
