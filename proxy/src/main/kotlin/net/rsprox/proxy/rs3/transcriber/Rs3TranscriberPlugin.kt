...
public class Rs3TranscriberPlugin(
    ...
    override fun onServerPacket(prot: ClientProt, message: IncomingMessage) {
        ...
        when (prot.toString()) {
            ...
            "MESSAGE_GAME" -> pass(message, Rs3Transcriber::legacyMessageGame)
            "NPC_INFO_V2" -> pass(message, Rs3Transcriber::npcInfo)
            "PLAYER_INFO" -> pass(message, Rs3Transcriber::playerInfo)
            "REBUILD_NORMAL" -> pass(message, Rs3Transcriber::legacyRebuildNormal)
            ...
            "MAP_PROJANIM" -> pass(message, Rs3Transcriber::legacyMapProjAnim)
            "MAP_PROJANIM_HALFSQ" -> pass(message, Rs3Transcriber::legacyMapProjAnimHalfsq)
            "MAP_PROJANIM_HALFSQ_V2" -> pass(message, Rs3Transcriber::legacyMapProjAnimHalfsqV2)
            "MAP_PROJANIM_V2" -> pass(message, Rs3Transcriber::legacyMapProjAnimV2)
            ...
            "CAM_SHAKE" -> pass(message, Rs3Transcriber::legacyCamShake)
            "CAM_FORCEANGLE" -> pass(message, Rs3Transcriber::legacyCamForceAngle)
            "CAM_MOVETO" -> pass(message, Rs3Transcriber::camMoveTo)
            "CAMERA_UPDATE" -> pass(message, Rs3Transcriber::legacyCameraUpdate)
            ...
            "HINT_TRAIL" -> pass(message, Rs3Transcriber::legacyHintTrail)
            "HINT_ARROW" -> pass(message, Rs3Transcriber::legacyHintArrow)
            "CHAT_FILTER_SETTINGS_PRIVATECHAT" -> pass(message, Rs3Transcriber::chatFilterSettingsPrivateChat)
            "SET_PLAYER_OP" -> pass(message, Rs3Transcriber::legacySetPlayerOp)
            ...
            "PROJANIM_SPECIFIC_V2" -> pass(message, Rs3Transcriber::legacyProjAnimSpecificV2)
